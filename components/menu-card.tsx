...
export default function MenuCard({
  ...
  return (
    <div 
      className="relative w-full md:w-80 rounded-lg border border-stone-200 pb-2 shadow-md transition-all hover:shadow-xl dark:border-stone-700 dark:hover:border-white"
